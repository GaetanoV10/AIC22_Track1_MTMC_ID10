...
def extract_image_feat(_cfg):
    ...
    det_img_dir = os.path.join(_cfg.DET_IMG_DIR, 'detect_result')
    image_list = load_all_data(det_img_dir)
    ...
    save_feature(_cfg.OUTPUT_DIR, det_img_dir, pool_output)
